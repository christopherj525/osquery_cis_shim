...
if __name__ == '__main__':
	...
	show_full_name = main.plist_value('/Library/Preferences/com.apple.loginwindow.plist', 'SHOWFULLNAME')
	accounts_and_environment_plist.update(show_full_name)

	# 6.1.2 Disable "Show password hints" (Scored)
	try:
		retries_until_hint = main.plist_value('/Library/Preferences/com.apple.loginwindow.plist', 'RetriesUntilHint')
